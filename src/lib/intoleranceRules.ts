// Reglas clínicas por intolerancia / patología / condición fisiológica.
// Se usan tanto en el prompt del Generador de Planes como en el Recetario.

export function buildIntoleranceRules(
  intolerances: string[],
  ...
  return intolerances
    .map(intol => {
      ...
      if (intol.includes('SiBO')) return [
        'SIBO (Sobrecrecimiento Bacteriano Intestinal) — DIETA BAJA EN FODMAPs.',
        'Protocolo de Fase de Restricción de 6 a 8 semanas según el material clínico de la Lic. Rosana Roldán (M.N. 3884).',
        '',
        'ALIMENTOS PROHIBIDOS (alto contenido en FODMAP — NO INCLUIR bajo ningún concepto):',
        '- Lácteos fermentables: crema de leche, helado, leche común, quesos blandos, yogur.',
        '- Frutas y frutas secas: almendras, castañas de cajú, caqui, cereza, ciruela (fresca y desecada), damasco, dátil, durazno, frutas enlatadas, granada, higo, mango, manzana, orejón, pasa de uva, pelón, pera, pistacho, sandía.',
        '- Vegetales fermentables: ajo, alcaucil, apio, arveja, batata, brócoli, calabaza, cebolla, choclo, coliflor, espárrago, mandioca, puerro, remolacha, repollo.',
        '- Cereales: trigo, centeno, cebada, amaranto, arroz integral.',
        '- Legumbres: garbanzo, lenteja, poroto rojo, soja (excepto tofu).',
        '- Dulces y edulcorantes: azúcar, caramelos, chocolate, golosinas, galletitas, edulcorantes terminados en "ol" (sorbitol, manitol, xilitol, maltitol, isomalt), JMAF, miel, jarabe de arce.',
        '- Bebidas: bebida de soja, jugos industriales, ron, vino blanco, gaseosas, cerveza.',
        '',
        'ALIMENTOS PERMITIDOS (bajo contenido en FODMAP — USAR PREFERENTEMENTE estos):',
        '- Lácteos: leche deslactosada; quesos camembert, cheddar, cottage, duros, mozzarella, queso de cabra.',
        '- Frutas y frutas secas: arándano, ananá, avellana, banana (fresca y desecada), frambuesa, frutilla, kiwi, mandarina, maní, maracuyá, melón, mora, naranja, nuez pecan, papaya, pomelo, semillas de girasol/chía/calabaza/sésamo, uva.',
        '- Vegetales: acelga, alfalfa, berenjena, brote de soja, chaucha, espinaca, hinojo, lechuga, limón, lima, morrón, nabo, papa, pepino, rábano, repollo chino, repollo colorado, repollito de Bruselas, tomate, zanahoria, zucchini.',
        '- Cereales sin gluten: almidón de maíz, arroz blanco, mijo, maíz, sorgo, quinoa.',
        '- Legumbres permitidas: tofu (única excepción dentro de las legumbres).',
        '- Proteínas LIBRES (consumo sin restricción FODMAP): huevo, carne vacuna, ave, pescado.',
        '- Grasas y aceites: aceite de oliva, canola, girasol, maíz, manteca, margarina.',
        '- Bebidas: té, café, té de hierbas, salvado de avena, Psyllium, salvado de arroz, bebida de arroz/avellana/avena/arándano/cereza, vino tinto (moderado), vodka, whisky.',
        '- Edulcorantes permitidos: Nutrasweet, Sucralosa, aspartame, Stevia, Sacarina (todo edulcorante que NO termine en "ol").',
        '',
        'COMENTARIOS ESPECIALES (incluir en el plan / recomendaciones cuando aplique):',
        '- Limitar alcohol; beber mucha agua; comer con moderación; masticar bien.',
        '- Limitar o evitar carnes procesadas (panchos, hamburguesas no caseras, fiambres).',
        '- Al concluir la fase de restricción (6-8 semanas), reintroducir alimentos uno nuevo por semana, dejando para el final: harinas, lácteos, cebolla, ajo y cerveza.',
        '- Si el paciente tiene confirmada intolerancia a la fructosa, considerar la carga total tolerada (prueba de hidrógeno en aire espirado) para no restringir innecesariamente.',
        '- Transición posterior recomendada: dieta mediterránea.',
        '',
        'REGLA OPERATIVA PARA EL OUTPUT: cualquier receta, plato o lista de compras que generes debe usar EXCLUSIVAMENTE alimentos de la lista permitida. Si una preparación tradicional incluye ajo o cebolla, reemplazá por aceite de oliva infusionado, cebolla de verdeo solo la parte verde, o hierbas frescas. No menciones miel/azúcar como edulcorante — usar Stevia/Sucralosa.',
      ].join('\n');
