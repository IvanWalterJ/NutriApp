    ...
    <footer className="bg-surface border-t-2 border-border-color p-8 mt-16 text-center text-text-muted no-print">
      <div className="flex flex-wrap gap-4 justify-center mb-6">
        <button
          ...
          className="px-6 py-3 bg-surface border-2 border-border-color rounded-xl font-bold flex items-center gap-2.5 transition-all hover:border-primary hover:text-primary hover-lift shadow-sm active:scale-95"
        >
